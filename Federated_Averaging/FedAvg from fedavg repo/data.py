...
def fetch_dataset():
    ...
    train_data = torchvision.datasets.CIFAR10(
        './data/cifar-10', train=True, download=True, transform=transform
    )

    test_data = torchvision.datasets.CIFAR10(
        './data/cifar-10', train=False, download=True, transform=transform
    )
...
def iid_partition_loader(data, bsz=50, n_clients=50):
...
def noniid_partition_loader(
    data, bsz=50, m_per_shard=250, n_shards_per_client=2
):
    ...
    Cifar-10 use 250 shards bc 50000/200=250 while MNIST=300 bc 60000/300=200
    """
